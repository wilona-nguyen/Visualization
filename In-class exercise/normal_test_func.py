...
def shapiro_test(x, title):
    ...
    alpha = 0.01
    if p > alpha :
        print(f'Shapiro test: {title} dataset looks Normal')
    else:
        print(f'Shapiro test: {title} dataset looks Not Normal')
    print('=' * 50)
...
def da_k_squared_test(x, title):
    ...
    alpha = 0.01
    if p > alpha :
        print(f'da_k_squaredtest:  {title} dataset looks Normal')
    else:
        print(f'da_k_squared test : {title} dataset looks Not Normal')
    print('=' * 50)
